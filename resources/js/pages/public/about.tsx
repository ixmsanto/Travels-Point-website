    ...
    return (
        <>
            ...
            <Section
                bg="surface"
                spacing="none"
                className="pt-[clamp(48px,7vw,92px)] pb-[clamp(40px,5vw,64px)]"
            >
                <div className="grid items-center gap-[clamp(28px,4vw,56px)] lg:grid-cols-2">
                    <div data-reveal>
                        ...
                        <p className="mt-5 text-[clamp(15px,1.5vw,18px)] leading-[1.75] text-soft">
                            ...
                            obsessive for us. What started as three planners at
                            a single desk is now a team of specialists who have
                        ...
                        <p className="mt-4 text-[clamp(15px,1.5vw,18px)] leading-[1.75] text-soft">
                            ...
                            answer the phone at 2am, remember that you like a
                            high floor, and know which café has the view worth
                            the detour.
                        </p>
                    ...
                    <div data-reveal className="relative">
                        ...
                        <div className="absolute -bottom-3.5 -left-3.5 flex items-center gap-3 rounded-card border border-border bg-surface p-[15px] shadow-[var(--shadow-md)]">
                            <IconTile
            ...
            <Section bg="muted">
                <div data-stagger className="grid gap-5.5 sm:grid-cols-2">
                    <article className="rounded-card border border-border bg-surface p-[30px] shadow-[var(--shadow-sm)]">
                        <IconTile
                            icon="rocket_launch"
                            iconSize={27}
                            tone="primary"
                        ...
                        <p className="mt-2.5 text-[15.5px] leading-[1.7] text-soft">
                            To turn the world&rsquo;s most beautiful places into
                            journeys that feel effortless, personal and
                ...
                >
                    {values.map((v) => (
                        <div
                            key={v.label}
                            className="flex items-center gap-3.5 rounded-card border border-border bg-surface px-5 py-4.5"
                        >
                            <IconTile
                                icon={v.icon}
                                iconSize={21}
            ...
            {/* ===== OUR STORY (timeline) ===== */}
            <Section bg="surface" width="narrow">
                <SectionHeading
                    eyebrow="Our Story"
            ...
            <Section bg="muted">
                ...
                >
                    {trust.map((t) => (
                        <article
                            key={t.title}
                            className="rounded-card border border-border bg-surface p-6 shadow-[var(--shadow-sm)] transition hover:-translate-y-1.5 hover:shadow-[var(--shadow-md)]"
                        >
                            <IconTile
                                icon={t.icon}
                                iconSize={25}
            ...
            <Section bg="brand-deep">
                ...
                >
                    {certs.map((c) => (
                        <div
                            key={c.name}
                            className="rounded-card border border-white/12 bg-white/[0.06] p-7 text-center backdrop-blur"
                        >
                            <span className="mx-auto mb-3.5 flex size-[52px] items-center justify-center rounded-card bg-gold/15 text-gold">
